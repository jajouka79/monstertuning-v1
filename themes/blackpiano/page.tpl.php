<?php
// $Id: page.tpl.php,v 1.3 2011/01/23 10:50:15 webmatter Exp $ 
/**
 * @file
...
?>
  ...
  <div id="page-wrapper"><div id="page"> <?php if ($main_menu): ?>
...
<div id="logo-title">
  ...
  </div>   <?php print render($page['header']); ?><?php print $feed_icons; ?>
    ...
    </div>   <?php if ($page['sidebar_second']): ?>
...
<div id="return_top"><a href="#page-wrapper" >&nbsp;</a></div>